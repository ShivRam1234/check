...
SECRET_KEY = '6fjdu%2gy702zj^nk&#7-d2mrly1-=_g1m8lv2dr_)wul*hftl'
DEBUG = True
ALLOWED_HOSTS = ['*']
INSTALLED_APPS = [
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR + '/templates', BASE_DIR + '/filmitouch/dynamicTemplate'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
     'default': {
        ...
        'NAME': 'ddi557n1im147c',
        'USER': 'xptfskuashepkn',
        'PASSWORD':'3f9f1c1c17c31a1919f5f4922bec856ad2aecbd4c32727da304e2e96c6d5eec6',
